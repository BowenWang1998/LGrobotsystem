...
#include <QMessageBox>
#include <iostream>
#include "../include/qt_ros_project/main_window.hpp"
/*****************************************************************************
** Namespaces
*****************************************************************************/
	...
	, qnode(argc,argv)
{
  ...
  ui.camera_label1->setScaledContents(true);
  ui.camera_label2->setScaledContents(true);
  ui.camera_label3->setScaledContents(true);
  ui.camera_label4->setScaledContents(true); //更新摄像头大小为适应窗口1
    ...
    QObject::connect(&qnode,SIGNAL(image1_vel(QImage)),this,SLOT(slot_update_image1(QImage)));  //渲染label画面
    QObject::connect(&qnode,SIGNAL(image2_vel(QImage)),this,SLOT(slot_update_image2(QImage)));  //渲染label画面
...
void MainWindow::slot_update_image1(QImage im){
  ui.camera_label1->setPixmap(QPixmap::fromImage(im));
}
void MainWindow::slot_update_image2(QImage im){
  ui.camera_label2->setPixmap(QPixmap::fromImage(im));
}
void MainWindow::slot_update_image3(QImage im){
  ui.camera_label3->setPixmap(QPixmap::fromImage(im));
}
void MainWindow::slot_update_image4(QImage im){
  ui.camera_label4->setPixmap(QPixmap::fromImage(im));
}
/*
...
void MainWindow::ReadSettings() {
    QSettings settings("Qt-Ros Package", "qt_ros_project");
