...
"}"));
        QIcon icon6;
        icon6.addFile(QStringLiteral(":/images/return.png"), QSize(), QIcon::Normal, QIcon::Off);
...
"}"));
        QIcon icon7;
        iconThemeName = QStringLiteral("://images/mutil_pose.png");
        if (QIcon::hasThemeIcon(iconThemeName)) {
            icon7 = QIcon::fromTheme(iconThemeName);
        } else {
            icon7.addFile(QStringLiteral("."), QSize(), QIcon::Normal, QIcon::Off);
        }
        set_mutil_goal_btn->setIcon(icon7);
...
"}"));
        ...
        stackedWidget_left->setCurrentIndex(2);
    ...
    void retranslateUi(QMainWindow *MainWindowDesign)
    {
        ...
        set_mutil_goal_btn->setText(QApplication::translate("MainWindowDesign", "Map edit", Q_NULLPTR));
